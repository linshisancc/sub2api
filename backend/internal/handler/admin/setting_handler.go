...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		FeishuLoginBruteforceAutobanEnabled:                    settings.FeishuLoginBruteforceAutobanEnabled,
		LoginBruteforceMaxFailures:                             settings.LoginBruteforceMaxFailures,
		LoginBruteforceWindowMinutes:                           settings.LoginBruteforceWindowMinutes,
		LoginBruteforceBanMinutes:                              settings.LoginBruteforceBanMinutes,
