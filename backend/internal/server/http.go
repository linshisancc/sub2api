...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, ipBanCheck, loginBruteforceTracker, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
